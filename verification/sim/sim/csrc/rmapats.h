...
void  rmaPropagate3_p_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_top_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_top_tb_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate3_r_top_tb_daidir (UB  * pcode);
void  rmaPropagate3_wn_top_tb_daidir (UB  * pcode, scalar  val);
